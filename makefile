...
OBJS = src/algo.o src/arg_parsing.o src/bsp.o src/bsp_test.o src/image_out.o src/snowflake.o src/snowflake_gen.o src/tga.o
...
src/image_out.o: src/algo.h src/bsp.h src/tga.h src/image_out.h
